...
function Navbar() {
    ...
    <>
                        ...
                        <li>
                            <a href='/pro' className="cursor-pointer px-2  
                            rounded-lg  hover:bg-orange-500 hover:text-white duration-200">Pro</a>
                        </li>
                        <li>
        ...
        sticky?"sticky-navbar shadow-md bg-base-300 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out":""
            ...
            <div className="navbar ">
                <div className="navbar-start ">
                    ...
                    <a className="text-2xl font-bold cursor-pointer">bookoholic</a>
                </div>
